...
const CategoryProductListPage = ({ containerTitle, produtos, resultCount }) => {
                    ...
                    <div className="archive-header">
                        <div className="row align-items-center">
                            <div className="col-xl-3">
                                <h1 className="mb-15">{containerTitle}</h1>
                                <div className="breadcrumb">
                                    <a href="/" rel="nofollow"><i className="fi-rs-home mr-5"></i>Home</a>
                                    <span></span> Loja <span></span> Categoria <span></span> {containerTitle}
                                </div>
                            </div>
                        </div>
                    </div>
                                    ...
                                    <div className="product-cart-wrap mb-30 wow animate__animated animate__fadeIn" data-wow-delay=".1s">
                                        ...
                                        <div className="product-content-wrap">
                                            <div className="product-category">
                                                <a href="#">{p.categoria_titulo || containerTitle}</a>
                                            </div>
